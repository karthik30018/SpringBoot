...
- Top 10 security risk : [OWASP Top 10](https://owasp.org/www-project-top-ten/)
- Required dependency : **spring-boot-starter-security**
- By adding the above dependency it will redirect to default login page when we hit the endpoint, the user name is **user** and password will be available in the terminaL.
- Even the logout page will be there if we hit the endpoint with **'/logout'**.
- ![WhatsApp Image 2025-09-07 at 20 39 48_44c4207a](https://github.com/user-attachments/assets/a24efd00-a016-444b-98da-64b5470a00c2)

## Spring Security Filters

- ![WhatsApp Image 2025-09-07 at 20 49 38_cb144865](https://github.com/user-attachments/assets/fa66d5ad-1e14-4fa1-8be7-bceda79978ec)
- **Filter chain** : sequence of filter, perticular order should be maintained.

## Session 

-  Every time we log in a session is created.
-  We can find the session id in cookies
-  <img width="1907" height="968" alt="image" src="https://github.com/user-attachments/assets/2267ecb1-2a50-4ae5-9e13-a0731de40793" />

## Setting username and password

- By setting it application.properties
- <img width="1841" height="880" alt="image" src="https://github.com/user-attachments/assets/1eb509f6-a7d9-420b-8ed7-78b5e41a968c" />
...
- To consume the login page which was generated by spring security in RestAPI or React.js or postman.
- <img width="1918" height="956" alt="image" src="https://github.com/user-attachments/assets/8d37d9e0-4761-4a63-b334-a629c9c03c0d" />
